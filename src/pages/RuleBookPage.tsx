...
import { FileText, Download, ExternalLink, BookOpen, Scale, Users, Award } from 'lucide-react';
...
const rules = [
  {
    ...
    description: 'Complete rules and regulations for participating in debate tournaments.',
  },
  {
    icon: Scale,
    title: 'Judging Criteria',
    description: 'Detailed scoring rubric and evaluation parameters for judges.',
  },
  {
    icon: Users,
    title: 'Team Formation',
    description: 'Guidelines for team composition and registration requirements.',
  },
  {
    icon: Award,
    title: 'Speaker Rules',
    description: 'Time limits, speaking order, and conduct expectations for speakers.',
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Official guidelines and regulations for all society activities and competitions.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="glass-card p-8 md:p-12 rounded-2xl bg-gradient-to-r from-gold-500/10 via-gold-500/5 to-gold-500/10 border border-gold-500/20 max-w-4xl mx-auto">
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="w-24 h-28 rounded-xl bg-gradient-to-br from-navy-700 to-navy-800 border border-white/10 flex items-center justify-center relative shadow-2xl">
                  ...
                  <div className="absolute bottom-2 text-[10px] text-gray-400">PDF</div>
                </div>
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-gray-400 mb-6">
                    Complete handbook containing all rules, regulations, and guidelines for
                    participating in Debating Society events and competitions.
                  </p>
                  <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">

  <motion.a
    href="/rulebook.pdf"
    download="NSUT_DebSoc_RuleBook.pdf"
    whileHover={{ scale: 1.05 }}
    whileTap={{ scale: 0.95 }}
    className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-gold-500 to-gold-600 text-navy-900 font-semibold rounded-full"
  >
    ...
    View Online
          ...
          >
            <p className="text-gray-400 text-sm max-w-2xl mx-auto">
              For any clarifications or queries regarding the rule book, please contact the
              Senior Council at{' '}
              <a href="mailto:debating@nsut.ac.in" className="text-gold-500 hover:underline">
                debating@nsut.ac.in
              </a>
            </p>
          </motion.div>
