...
const RULEBOOK_LINK =
  'https://drive.google.com/file/d/1lEjLGVJPNxHLLACTHi1dZjJTQfcZCWSI/view?usp=sharing';
...
<div className="flex-1 text-center md:text-left">
  ...
  <div className="mb-8">
    <p className="text-sm text-gold-500 uppercase tracking-wider">
      Google Drive PDF 
    </p>
  </div>
  ...
  <motion.a
    ...
    whileTap={{ scale: 0.95 }}
    className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-gold-500 to-gold-600 text-navy-900 font-semibold rounded-full shadow-lg hover:shadow-gold-500/20 transition-all"
  >
