...
export default function JuniorCouncil() {
  return (
    <section id="junior-council" className="py-24 bg-navy-800 relative overflow-hidden">
      {/* Background Gradient */}
            ...
            >
              <div className="glass-card overflow-hidden rounded-2xl bg-white/5 border border-white/10 hover:border-gold-500/30 transition-all duration-300">
                ...
                <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                  <div className="absolute inset-0 rounded-2xl shadow-[0_0_30px_rgba(212,175,55,0.2)]" />
                </div>
              </div>
            </motion.div>
          ))}
