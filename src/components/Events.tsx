...
const events = [
  ...
  },
  {
    ...
    date: 'October 2024',
    location: 'Convention Center, NSUT',
...
export default function Events() {
  return (
    <section id="events" className="py-24 bg-navy-900 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-3 px-8 py-4 border border-gold-500 text-gold-500 rounded-full font-semibold hover:bg-gold-500/10 transition-all"
          >
            <Calendar size={20} />
            View All Events
          </motion.button>
